...
class DialogueController(Protocol):
    ...
    def tick(self, scene_graph: SceneGraph | DesktopTree) -> None: ...
    def is_option_present(self, tree: SceneGraph | DesktopTree) -> bool: ...
    def select_best_option(self, tree: SceneGraph | DesktopTree, option_registry: dict[str, Any] | None = None) -> Any: ...
