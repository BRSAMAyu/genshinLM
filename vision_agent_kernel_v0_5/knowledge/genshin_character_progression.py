...
_ASCENSION_COSTS: dict[int, AscensionMats] = {
    ...
    40: AscensionMats(40, 40000,
                      ...
                      local_specialty=10, common_damaged=15, common_intact=0, common_phosphorescent=0,
                      boss_material=2),
    50: AscensionMats(50, 60000,
                      gem_sliver=0, gem_fragment=6, gem_chunk=0, gem_gemstone=0,
                      local_specialty=20, common_damaged=0, common_intact=12, common_phosphorescent=0,
                      boss_material=4),
    60: AscensionMats(60, 80000,
                      gem_sliver=0, gem_fragment=0, gem_chunk=3, gem_gemstone=0,
                      local_specialty=30, common_damaged=0, common_intact=18, common_phosphorescent=0,
                      boss_material=8),
